...
<head>
  ...
  <title>Admin web gia dụng</title>
          ...
          <li class="nav-item">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                ...
                <a href="javaScript:void();">
                  <div class="media">
                    ...
                    <div class="media-body">
                      <h6 class="mt-2 user-title">Webgiadung</h6>
                	<b> Admin:  ${userLogin.name}</b>                         
                    </div>
                  </div>
                </a>
              </li>
              ...
              <li class="dropdown-divider"></li>
               <li class="dropdown-item"><i class="fa fa-key"></i><a href="${pageContext.request.contextPath}/admin/editpass"> Đổi mật khẩu</a></li>
                 <li class="dropdown-item"><i class="fa fa-home"></i><a href="${pageContext.request.contextPath}/"> Về trang chủ</a></li>	
