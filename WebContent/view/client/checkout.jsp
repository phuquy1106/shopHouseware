                        ...
                        <div class="panel-body">
                         <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                  <input type="date" placeholder="date" name="transaction_created" id="the-date" style="display: none">             
                              </div>                             
                            </div>                            
                          </div>             
                          ...
                          <div class="row" style="display: none">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                  <input type="text" placeholder="userid_session" name="transaction_usersession" value="${userLogin.username }"> 
              ...
              <div class="col-md-4">
                <div class="checkout-right">
                  ...
                  <div class="aa-payment-method">                    
                   ...
                   <c:if test="${userLogin != null && sessionScope.order == null}">
                   <br>
                   		<p style="color: green;">Bạn đã đặt hàng thành công!</p>
                   </c:if>
                </div>
              </div>
            </div>
