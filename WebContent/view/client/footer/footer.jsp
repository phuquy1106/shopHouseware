            ...
            <div class="row">
              <div class="col-md-4 col-sm-6">
                <div class="aa-footer-widget">
                  <a href="${pageContext.request.contextPath}/"><img src="${url}/images/logo_t1.png" alt="logo img" height="80px"  alt="logo img" width="185px"></a> 
                  <ul class="aa-footer-nav">

                    <li><p style="color:#888; text-align: justify; width: 95%">Là nơi chuyên buôn bán tất cả các mặt hàng gia dụng chất lượng. Chúng tôi luôn đặt tiêu chí về chất lượng và uy tín lên hàng đầu.</p></li>
              ...
              <div class="col-md-4 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>LIÊN HỆ</h3>
                    <address>
                      <p>Hoà Quý - Quận Ngũ Hành Sơn - TP Đà Nẵng</p>
                      <p><span class="fa fa-phone"></span>093.1948.893</p>
                      <p><span class="fa fa-envelope"></span>nguyenphuquy1106@gmail.com</p>
                    </address>
