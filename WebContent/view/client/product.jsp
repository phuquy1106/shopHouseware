	              ...
	              <div>
	                <nav aria-label="Page navigation example">
	  				<ul class="pagination">
	    				 ...
	    				 <c:if test="${phanbiet.equals('danhmuc') }">

	    				 <a class="page-link" id="${i}" href="${pageContext.request.contextPath}/view/client/product-id?id=${idcate}&index=${i}">${i}</a>
	    				 </c:if>
	    				 
	    				 <c:if test="${!phanbiet.equals('danhmuc') }">
	    				 <a class="page-link" id="${i}" href="${pageContext.request.contextPath}/view/client/product?index=${i}">${i}</a>
	    				 </c:if>	
	    				  </c:forEach></li> 
          ...
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <div class="aa-recently-views">
                <ul>
                 <c:forEach items="${productlist1}" var="product" end="3">
                   <c:if test="${product.status==1}">
                  <li>
                    ...
                    <div class="aa-cartbox-info">
                      ...
                      <c:choose>
						<c:when test="${product.discount == 0}">
	                        <p>  <c:set var="p" value="${product.price}"/>
								<fmt:setLocale value="vi_VN"/>
	                    ...
	                    <c:otherwise>
	                       <c:forEach items="${productlist}" var="product1">
		                      ...
		                      <span class="aa-product-price"><del><c:set var="p" value="${product.price}"/>
								<fmt:setLocale value="vi_VN"/>
