...
<section id="aa-catg-head-banner">
	<img
		src="${pageContext.request.contextPath}/view/client/assets/images/bg_giohang.jpg"
		width="100%" height="350px" alt="banner sản phẩm">
				...
				<div class="aa-product-catg-content">
					...
					<div class="aa-product-catg-body">
								...
								<li>
									<figure>
										<a class="aa-product-img"
											...
											src="<%=request.getContextPath() %>/files/${product.image_link}"></a>
												...
												<c:otherwise>
													<c:forEach items="${productlist1}" var="product1">
														<c:if test="${product1.id == product.id}">
															<span class="aa-product-price"> <c:set var="p"
																	value="${product1.price}" /> <fmt:setLocale
						...
						<script type="text/javascript">
							...
							/view/client/add-cart?product-id='
													+ id,
											type : 'POST',
											cache : false,
											data : {
					...
					<div>
						<nav aria-label="Page navigation example">
							<ul class="pagination">
								...
								<li class="page-item"><c:forEach begin="1" end="${endPage}"
										var="i">
										<a class="page-link" id="${i}"
											href="${pageContext.request.contextPath}/view/client/productsale?index=${i}">${i}</a>
									</c:forEach></li>
								...
								<c:forEach items="${productlist}" var="product" end="3">
								  <c:if test="${product.status==1}">
									<li><a
										...
										class="aa-cartbox-img"><img src="<%=request.getContextPath() %>/files/${product.image_link}"></a>
